             ...
             <div className="flex items-center gap-6">
                ...
                <div className="flex items-center gap-4">
                   ...
                   <div id="profile-dropdown" className="relative">
                      <div
                        className="w-8 h-8 rounded-full border border-white/10 flex items-center justify-center relative overflow-hidden group cursor-pointer"
                      ...
                      {/* Dropdown Menu */}
                      {profileDropdownOpen && (
                         <div className="absolute right-0 mt-2 w-48 bg-black/90 backdrop-blur-3xl border border-white/10 rounded-xl shadow-2xl z-50 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
                            <div className="py-2">
                               <button
                                  onClick={() => {
                                  ...
                                  className="w-full text-left px-4 py-2 text-[10px] font-black text-white/80 hover:text-white hover:bg-white/5 uppercase tracking-widest transition-all"
                               >
                                  Manage Account
                               </button>
                               <button
                                  ...
                                  className="w-full text-left px-4 py-2 text-[10px] font-black text-[#ef4444]/80 hover:text-[#ef4444] hover:bg-[#ef4444]/5 uppercase tracking-widest transition-all"
                               >
                                  Logout
                               </button>
                            </div>
